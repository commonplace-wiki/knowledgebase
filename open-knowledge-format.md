...
An OKF knowledge bundle is a Git repository of concepts. Commonplace maps its information like this:
...
* **Version control.** History, blame, branches, and pull requests work on wiki content exactly as they do on code.
