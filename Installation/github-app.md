...
timestamp: '2026-07-24T07:02:35.886Z'
---
...
To create it manually instead, go to _https://github.com/organizations/<YOUR_ORGANIZATION>/settings/apps]_, add a new GitHub App, and configure:
